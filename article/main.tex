...
- Documenting thinking processes: In orther to mitigate the externalization of the student's own reasoning, making reasoning visible becomes imperative, in order to achieve this, documentation presents a viable way of doing so. Documentation in this context does imply not only the outputs arrived to but the path taken to get there, questions asked along it and the frictions faced as well as the responses done to them.
- Structured transparency in AI use: Alongside the documentation of thinking processes, transparency protocols that reveal the use of LLMs in the different tasks could be of great utility, not only as a way of beig transparent with the teacher but also as a way of selfreflecting on the usage done, promoting "honest reflection, responsible use of AI, and clarity in collaborative, tech-assisted creation" \cite{fuentemilla2024ccl}

Inspired by practices emerging from communities such as the Barcelona Fab Lab, this approach involves developing shared agreements, something akin to an attribution or licensing system, that make explicit what role an LLM played in a given piece of work: where it was consulted, what it contributed, and where the student's own reasoning was determinant. Far from functioning as a surveillance mechanism, this kind of structured transparency serves to cultivate honesty, first with oneself and then with others, about the cognitive contributions involved in any intellectual product. It also opens a productive conversation about authorship, agency, and the boundaries of the self in an age when thinking is increasingly distributed across human and non-human actors.
...
The exposed proposals are just that, proposals, in order to appropiately put them into practice they should be evaluated and tested in their respective educational context, 
