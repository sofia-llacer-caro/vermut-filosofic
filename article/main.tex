...
\date{\today}
% question: 2021czarnowska what about those metrics?
\begin{document}
\maketitle
...
Independentment de les estratègies adoptades, resulta de gran importància emfatitzar que garantir una correcta i responsable integració dels LLMs a l'aula, implica una participació de tot el professorat. Just as digital literacy was never solely the responsibility of the informatics teacher, nor was writing the exclusive domain of the language teacher, critical engagement with LLMs belongs across the curriculum. 
...
It becomes central for teachers to adopt epistemic rather than instrumental understanding of AI: how can educators empower critical thinking over LLMs if they themselves take a "black box" approach to it?
