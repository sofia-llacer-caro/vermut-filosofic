...
<!--The renovation of the way we learn introduced by the maker community, especially when it comes to [] and [] [jorge can say more here. basically the point would be that the maker community is educational avantgarde so from all that has been learnt in this mindset and culture they should contribute to the framing of the role that llms can take in education looking forward.]. we choose therefore to see the massive adoption of llms in education (especially among students) not just as a tool change, but as an epistemic change, leaving plenty of room to think beyond isolated tools or "technologies", and onto a root questioning of the educational frameworks that empower learning and making.-->

# CONTEXT - TECHNOLOGY & EDUCATION (past, present & future)

## The past - technology as an object of knowledge
...
<!--[here it would be nice if you wrote a bit more, since you're more into it, jorge. what i would see though would be explaining the following]
- learning by doing
...
Nowadays, "Democratizing" is no longer a word which reflects an active participation in building or, in a way, making things beyond just using "user-friendly" platforms. Access to the technologies does not automatically mean understanding or questioning, the "user-friendly" economy is precisely that, <u>user<u> friendly. User being a passive interaction reduced to almost consumption. It contributes to increasing our comfort and dependence on black boxes, and comfort; as nice as it is, does not ask questions.

In Aesop's fable of the fox and the grapes, a fox spots a set of ripe grapes hanging in a branch that is out of his reach. He jumps and jumps, exhausting himself, and cannot get them. Rather than acknowledging his failure and figuring a way up, he walks away muttering: "I can see now plain enough that the grapes are sour, and not fit to be eaten" [godwin1818fables]. This fable represents self-deception, pretending not to want what we were not able to have. Something similar happens with "user-friendly" technology: by removing the effort required to understand how things work, the impulse to try gets removed. Richard Sennett [sennett2019construir] traces this back to Bill Gates' ideal of "friction-free" design, technology so "easy to use" that the user never needs to encounter the machinery beneath. Access widens, but understanding does not. In this scenario, the maker movement represents, in a way, a rejection of this ideal, reclaiming the friction that frictionless design have erased, and with it opening (both critically and literally), modifying, and questioning the tools we depend on. According to Sennett [sennett2019construir], it is precisely this culture of opening and questioning that sustains critical thinking. A society of users, shielded from complexity by smooth interfaces, loses not just technical literacy but the cognitive habit (no se si esto tiene sentido) of asking what could be otherwise ("what if...?").
